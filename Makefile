...
LDFLAGS += -lpthread -ldl -lm -lplist-2.0 -luuid -lsodium -lgcrypt -levent -levent_pthreads -L.
...
SOURCES = raop_client.c rtsp_client.c \
	  ...
	  airplay_client.c airplay_events.c commands.c misc.c player.c rtp_common.c \
	  aes.c aes_ctr.c \
	  dmap_parser.c	\
	  alac.c \
